...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data', type=str, default='data/yolov5s.yaml', help='data.yaml path')
    parser.add_argument('--data', type=str, default='voc_data/ship.yaml', help='data.yaml path')
    ...
    parser.add_argument('--workers', type=int, default=0, help='maximum number of dataloader workers')  # win10不支持
